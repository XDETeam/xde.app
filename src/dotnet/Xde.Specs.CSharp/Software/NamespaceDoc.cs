...
namespace Xde.Software
{
	...
	/// some contracts and attempt to sort out.
	/// TODO: Define software as compositions/features? As it can be for software developed
	/// using XDE? This approach can also replace interfaces.
	/// </remarks>
	[CompilerGenerated]
